...
package body TUI.Menu is
   ...
   Default_Board_Size : constant Positive := Types.Game_Types.Board_Size;
   ...
   function Prompt_Board_Size return Positive is
      Input_Line : String (1 .. 100);
      Input_Len  : Natural;
      ...
      loop
         ...
         begin
            ...
            begin
               ...
               if Parsed /= Default_Board_Size then
   ...
   function Get_Menu_Selection return Menu_Selection is
      ...
      Result     : Menu_Selection :=
        (Action => Menu_Quit, Board_Size => Default_Board_Size);
   begin
      loop
         Show_Start_Menu;
         Ada.Text_IO.Get_Line (Input_Line, Input_Len);
